...
int main() {
    ...
    cout << "The words starts with letter 0:" << endl;
    ...
    string word;
    cout << "write a word to chech if it is avaliable" << endl;
    cin >> word;

    for (int c = 0; c < 1000; c++) {
        if (words[c] == word){
            cout<< "There is a word like that" << endl;
        }
        else{
            cout<< "There is no word like that" << endl;
        }
